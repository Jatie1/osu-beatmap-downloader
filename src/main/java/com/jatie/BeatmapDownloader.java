...
public class BeatmapDownloader {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("4. Ensure that you have the 'Prefer no-video downloads' option enabled in the osu! settings. This will force osu!direct to download beatmaps without videos.");
